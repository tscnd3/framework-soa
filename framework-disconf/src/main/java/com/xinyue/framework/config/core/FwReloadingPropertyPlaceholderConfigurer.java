...
public class FwReloadingPropertyPlaceholderConfigurer extends DefaultPropertyPlaceholderConfigurer implements
...
BeanDefinitionVisitor visitor =
        new FwReloadingPropertyPlaceholderConfigurer.PlaceholderResolvingBeanDefinitionVisitor(props);
